...
using MFramework.Common.Core.XML;
using XmlSerializer = MFramework.Common.Core.Serializers.XmlSerializer;
    ...
    public class PropertyBag<TValue> : Dictionary<string, TValue>, IXmlSerializable
    {
        ...
        public void WriteXml(System.Xml.XmlWriter writer)
        {
            foreach (string key in this.Keys)
            {
                ...
                string xmlType =XMLHelper.MapTypeToXmlType(type);
                bool isCustom = false;
            ...
            while (reader.Read())
            {
                if (reader.NodeType == XmlNodeType.Element && reader.Name == "key")
                {
                    ...
                    else if (xmlType.StartsWith("___"))
                    {
                        ...
                        Type type = ReflectionHelper.GetTypeFromName(xmlType.Substring(3));
                        ...
                        value = (TValue)reader.ReadElementContentAs(XMLHelper.MapXmlTypeToType(xmlType), null);
        ...
        public string ToXml()
        {
            ...
            return Serializer.XmlSerializer.Serialize(this);
        }
        ...
        public bool FromXml(string xml)
        {
            ...
            var result = Serializer.XmlSerializer.Deserialize<PropertyBag<TValue>>(xml);
